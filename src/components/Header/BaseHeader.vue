<template>
    <Container class="bg-primary  p-3" style="align-self: stretch">
        ...
        <DynamicHeightWrapper class="transition-all overflow-hidden" :style="{height: stretch ?  computedHeight + 'px' :'0px'}">
