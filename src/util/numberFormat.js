export default {
    ...
    thousands2K2M: function (number,reservedDecimal = 2) {
        if(number >= 1000000) {
            ...
            let formattedString = numberString.substring(0,numberString.indexOf('.') + reservedDecimal) + 'M'
            if(formattedString.endsWith('0M') && reservedDecimal > 0){
        ...
        if(number >= 1000) {
            ...
            let formattedString = numberString.substring(0,numberString.indexOf('.') + reservedDecimal) + 'K'
            if(formattedString.endsWith('0K') && reservedDecimal > 0){
