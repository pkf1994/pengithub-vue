<template> 
    <Container class="bubble m-0 bg-white">
        <HideAndShowPane v-if="commentExtraDataHolder.isMinimized" class="p-3 d-flex flex-justify-between p-3 text-gray text-small border-bottom">
        ...
        <AnimatedHeightWrapper :stretch="showMinimized || !commentExtraDataHolder.isMinimized">
            ...
            <Body class="pb-2 p-3" v-if="!loading && commentExtraDataHolder.bodyHTML">
                <BodyHTML v-html="commentExtraDataHolder.bodyHTML"  class="markdown-body f5 p-0">
