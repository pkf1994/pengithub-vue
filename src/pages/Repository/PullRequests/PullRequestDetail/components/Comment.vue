        ...
        <Inner class="bg-white">
            ...
            <AnimatedHeightWrapper>
                <Body class="pb-2 p-3" v-if="!loading && commentExtraDataHolder.bodyHTML">
                    ...
                    <Reaction v-if="commentExtraDataHolder.viewerCanReact || withReaction" class="border-gray-dark d-flex flex-justify-start flex-wrap mt-2">
