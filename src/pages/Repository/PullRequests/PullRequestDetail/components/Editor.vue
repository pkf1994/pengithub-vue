<template>
    <Container>
            ...
            <EditPane v-if="selectedTab === 'Write'">
                    <markdown-toolbar for="textarea" class="bg-white d-flex no-wrap flex-items-start flex-wrap px-2 pt-2">
                        ...
                        <AnimatedHeightWrapper :stretch="stretch">
                            <MDGroup class="d-block width-full clearfix">
                    ...
                    <textarea   rows="6" 
                                ...
                                class="mt-3 d-block width-full form-control" 
                                id="textarea" 
                                v-model="markdownRaw"
        ...
        <Action class="d-flex flex-justify-end mt-2" v-if="!locked">
            <button class="btn" v-if="commentExtraGraphqlDataGetter().viewerCanUpdate" :disabled="markdownRaw === ''">
...
<script>
    ...
    export default {
        inject: ['commentExtraGraphqlDataGetter'],
        props: {
            locked: {
                type: Boolean,
                default: false
