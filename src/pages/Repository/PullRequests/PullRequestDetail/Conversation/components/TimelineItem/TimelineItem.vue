<template>
        ...
        <!-- head_ref_deleted  -->
        <Other v-else-if="data.event === 'head_ref_deleted'" :data="data">
            <template v-slot:icon>
        ...
        <!-- reopened  -->
        <Other v-else-if="data.event === 'reopened'" :data="data" :badgeStyle="{color:'#28a745'}">
            <template v-slot:icon>
...
<script>
    ...
    import {HeadRefForcePushed,Committed,CommittedGroup} from './components'
