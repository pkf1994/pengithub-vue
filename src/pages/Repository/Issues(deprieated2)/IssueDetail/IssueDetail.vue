    ...
    export default {
        ...
        methods: {
            ...
            async network_getData() {
                ...
                try{
                    let cancelToken = this.cancelAndUpdateAxiosCancelTokenSource(this.$options.name).cancelToken
                    ...
                    let graphql_extraData = graphql.GRAPHQL_ISSUE_EXTRA_DATA
            ...
            async network_getTimelineCount() {
                try{
                    ...
                    let cancelToken = this.cancelAndUpdateAxiosCancelTokenSource(this.$options.name + '_timeline_count').cancelToken
