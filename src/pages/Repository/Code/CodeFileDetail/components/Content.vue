                ...
                <Header class="Box-header py-2 d-flex flex-column flex-shrink-0">
                    <Pane class="d-flex py-1 py-md-0 flex-auto flex-justify-between">
                        ...
                        <EditOrDelete class="d-flex">
                            <button :disabled="!currentRef || !path" @click="goEditPage" v-if="contentType == 'html' || contentType == 'text'" class="d-block btn-octicon">
                            ...
                            <button :disabled="!currentRef || !path" @click="goDeletePage" class="d-block btn-octicon">
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            fileEditRouterLink() {
                return `/${this.owner}/${this.repo}/edit/${this.currentRef}/${this.path}`
            },
            fileDeleteRouterLink() {
                return `/${this.owner}/${this.repo}/delete/${this.currentRef}/${this.path}`
            },
        },
        methods: {
            goEditPage() {
                this.$router.push(this.fileEditRouterLink)
            },
            goDeletePage() {
                this.$router.push(this.fileDeleteRouterLink)
            }
        },
        components: {
            ImgWrapper,
