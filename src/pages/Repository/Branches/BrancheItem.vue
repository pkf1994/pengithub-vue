<template>
    <Container class="Box-row d-flex flex-items-center Details position-relative" style="padding-top:8px;padding-bottom:8px;">
        <Main class="d-flex css-truncate flex-wrap width-full" style="line-height:1.25" :style="magicStyle">
            <router-link to="/" class="branch-name css-truncate-target v-align-baseline width-fit mr-2 ">{{branch.name}}</router-link>
