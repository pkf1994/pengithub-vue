...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState({
                loading: state => state.repository.issue.closed.loading,
                data: state => state.repository.issue.closed.nodes,
                pageInfo: state => state.repository.issue.closed.pageInfo,
                totalCount: state => state.repository.issue.closed.totalCount,
                currentPage: state => state.repository.issue.closed.currentPage,
                perPage: state => state.repository.issue.closed.perPage
            })
        },
        created(){
            this.action_getData({
