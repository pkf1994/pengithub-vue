            ...
            <EditPane v-if="selectedTab === 'Write'">
                <markdown-toolbar :for="uniqueId" class="bg-white d-flex no-wrap flex-items-start flex-wrap px-2 pt-2">
                   <MDGroup class="d-flex flex-wrap mr-0 mb-2 text-gray">
                       <template v-for="item in toolbarArray">
                            <md-header :key="item" v-if="item == 'header'" class="toolbar-item tooltipped p-2 mr-1">
                            ...
                            <md-bold :key="item" v-else-if="item == 'bold'" class="toolbar-item tooltipped p-2 mr-1">
                            ...
                            <md-italic :key="item" v-else-if="item == 'italic'" class="toolbar-item tooltipped p-2 mr-1">
                            ...
                            <md-quote :key="item" v-else-if="item == 'quote'" class="toolbar-item tooltipped p-2 mx-1">
                            ...
                            <md-code :key="item" v-else-if="item == 'code'" class="toolbar-item tooltipped p-2 mx-1">
                                <svg class="octicon octicon-code" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M4.72 3.22a.75.75 0 011.06 1.06L2.06 8l3.72 3.72a.75.75 0 11-1.06 1.06L.47 8.53a.75.75 0 010-1.06l4.25-4.25zm6.56 0a.75.75 0 10-1.06 1.06L13.94 8l-3.72 3.72a.75.75 0 101.06 1.06l4.25-4.25a.75.75 0 000-1.06l-4.25-4.25z"></path></svg>
                            </md-code>
                            <md-link :key="item" v-else-if="item == 'link'" class="toolbar-item tooltipped p-2 mx-1">
                                <svg class="octicon octicon-link" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M7.775 3.275a.75.75 0 001.06 1.06l1.25-1.25a2 2 0 112.83 2.83l-2.5 2.5a2 2 0 01-2.83 0 .75.75 0 00-1.06 1.06 3.5 3.5 0 004.95 0l2.5-2.5a3.5 3.5 0 00-4.95-4.95l-1.25 1.25zm-4.69 9.64a2 2 0 010-2.83l2.5-2.5a2 2 0 012.83 0 .75.75 0 001.06-1.06 3.5 3.5 0 00-4.95 0l-2.5 2.5a3.5 3.5 0 004.95 4.95l1.25-1.25a.75.75 0 00-1.06-1.06l-1.25 1.25a2 2 0 01-2.83 0z"></path></svg>
                            </md-link>

                            <md-unordered-list :key="item" v-else-if="item == 'unordered-list'" class="toolbar-item tooltipped p-2 mr-1">
                            ...
                            <md-ordered-list :key="item" v-else-if="item == 'ordered-list'" class="toolbar-item tooltipped p-2 mr-1">
                            ...
                            <md-task-list :key="item" v-else-if="item == 'task-list'" class="toolbar-item tooltipped p-2 mr-1">
                            ...
                            <md-mention :key="item" v-else-if="item == 'mention'" class="toolbar-item tooltipped p-2 mx-1">
                            ...
                            <md-image :key="item" v-else-if="item == 'image'" class="toolbar-item tooltipped p-2 mx-1">
                            ...
                            <md-ref :key="item" v-else-if="item == 'ref'" class="toolbar-item tooltipped p-2 mx-1">
