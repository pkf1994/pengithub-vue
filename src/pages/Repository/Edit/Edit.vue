<template>
        <CommonLoadingWrapper :loading="loading || allBranchesAndTags.loading || viewerPermission().loading || loadingFileContent" position="corner"> 
            ...
            <ActionPane class="p-3">
                <h3>Commit change</h3>
                <input v-model="commitMessageHeadline" type="text" :disabled="inputDisabledFlag" :placeholder="`Update ${fileName || 'change'}`" class="form-control input-block input-contrast"  name="message" value="" autocomplete="off">
...
<script>
    ...
    export default {
        name: "repository_edit_file_page",
        ...
        computed: {
            ...
            inputDisabledFlag() {
                return this.loading || this.allBranchesAndTags.loading || this.viewerPermission().loading || this.loadingFileContent
            },
            ...
            breadcrumbRoutePath() {
                let regExp = new RegExp(`^\/${this.owner}\/${this.repo}\/edit`)
        ...
        methods: {
            async network_getData() {
                ...
                this.network_getFileContent()
            },
            async network_getFileContent() {
                try {
            ...
            async network_commitDirectly(targetBranch) {
                ...
                try{
                    ...
                    if(targetBranch) {
                        ...
                        this.$router.replace(`/${this.owner}/${this.repo}/blob/${this.currentRef}/${this.path}`)
                    }
                    this.routeResetHook()
                }catch(e) {
                    this.handleError(e)
