<template> 
    <Container class="bubble bg-white" style="margin-top:15px">
        <FileHeader class="file-header" :class="{pending:reviewComment.state && reviewComment.state.toLowerCase() == 'pending'}">
    ...
    export default {
        ...
        methods: {
            ...
            async network_getData() {
                if(this.reviewProvided().state && this.reviewProvided().state.toLowerCase() == 'pending') return
