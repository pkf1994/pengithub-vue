    ...
    export default {
        ...
        computed: {
            ...
            languageModalRouterLinkData() {
                let data = []
                this.repositories.filterLanguageList.data.filter(i => i.name.toLowerCase().indexOf(this.repositories.filterLanguageList.filterText.toLowerCase()) > -1 || i.urlParam.toLowerCase().indexOf(this.repositories.filterLanguageList.filterText.toLowerCase()) > -1).forEach( i => {
