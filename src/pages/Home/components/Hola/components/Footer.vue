<template>
    <footer class="mt-6">
        <GitHubPPSC class="py-5 px-3 mb-5 flex flex-wrap">
            ...
            <Categories class="col-6 mb-6" v-for="category in categories" :key="category.title">
                <CategoryTitle class="f5-mktg mb-3 font-mono text-gray-light">{{category.title}}</CategoryTitle>
                <ul>
                    <li v-for="item in category.items" class="f5-mktg lh-125 mb-3 text-gray" :key="item.title">
        ...
        <FooterEnd class="py-4 px-3 bg-gray-light">
            <SocialNetwork>
                <ul class="mb-3 flex flex-items-center">
                    <li v-for="item in socialNetworkList" class="mr-3" :key="item.href">
            ...
            <Statement>
                <ul class="flex f6 text-gray">
                    <li v-for="item in statementList" class="mr-3" :key="item.title">
