    ...
    <Container class="d-flex flex-items-baseline border-bottom border-gray py-3">
        ...
        <Content v-if="activity.type == 'ForkEvent'"  class="d-flex flex-column width-full">
            ...
            <Payload class="Box p-3 mt-2">
                ...
                <div class="f4 lh-condensed text-bold text-gray-dark css-truncate">
                    <router-link :to="`/${activity.repo.name}`" class="css-truncate-target link-gray-dark no-underline text-bold wb-break-all d-inline-block no-wrap">
                        {{activity.repo.name}}
                    </router-link>
                </div>
