<template>
    <Container class="py-4 border-bottom">
        ...
        <AnimatedHeightWrapper>
            <Description class="text-gray mb-2 pr-4" v-html="comprehensiveRepository.descriptionHTML">
            </Description>
        </AnimatedHeightWrapper>
        ...
        <TheMeta class="f6 text-gray mt-2">
            <PrimaryLanguage class="mr-3" v-if="comprehensiveRepository.language">
                <transition name="fade" appear>
                    <span v-if="comprehensiveRepository.primaryLanguage" class="repo-language-color" :style="{backgroundColor: comprehensiveRepository.primaryLanguage.color || '#ccc'}"></span>
                </transition>
            ...
            <License v-if="comprehensiveRepository.license" class="mr-3">
                ...
                {{comprehensiveRepository.license.spdx_id}}
            </License>
            ...
            <openIssueCount class="mr-3" v-if="comprehensiveRepository.issues && comprehensiveRepository.issues.totalCount > 0">
                ...
                {{comprehensiveRepository.open_issues_count}}
            </openIssueCount>
            
            <openIssueCount class="mr-3" v-if="comprehensiveRepository.pullRequests && comprehensiveRepository.pullRequests.totalCount > 0">
                ...
                {{comprehensiveRepository.pullRequests.totalCount}}
            </openIssueCount>
