            ...
            <SocialNetwork>
                <ul class="mb-3 d-flex flex-items-center"> 
                    <li v-for="item in socialNetworkList" class="mr-3 list-style-none" :key="item.href">
                        <a :href="item.href" style= "color:#959da5;" v-html="item.svg"></a>
                    </li>
                </ul>
            </SocialNetwork>
            ...
            <Statement>
                <ul class="d-flex f6 text-gray">
                    <li v-for="item in statementList" class="mr-3 list-style-none" :key="item.title">
                        <a :href="item.href" class="link-gray">
                            {{item.title}}
                        </a>
                    </li>
                </ul>
